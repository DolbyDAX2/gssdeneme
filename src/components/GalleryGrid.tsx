...
export default function GalleryGrid() {
  ...
  return (
    <section className="section-padding bg-[#f8fafc]" aria-label="Galeri">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="w-12 h-0.5 bg-[#3364ae] rounded-full mx-auto mb-4" />
          <h2 className="section-title">Şubemizden Kareler</h2>
          <p className="text-[#64748b] text-sm mt-1.5">
            Şube faaliyetlerimizden ve ziyaretlerimizden görüntüler
          </p>
        </div>
        ...
        {lightboxIndex !== null && (
          ...
          >
            ...
            {/* Lightbox content with gradient */}
            <div
              className="w-[80vw] h-[60vh] rounded-xl overflow-hidden"
              style={{
